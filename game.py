...
from engine import Grandmaster
import os
...
class Game(pg.sprite.Sprite):
            ...
            for event in pg.event.get():
                if event.type == pg.QUIT:
                    ...
                    if flag:
                        ...
                        if Grandmaster.if_possible(self.get_pos(coord1)):
                            flag = True
    ...
    def update(self, coord1):
        ...
        if self.board[cell1][cell2].rect.collidepoint(coord1):
            ...
            if player_move(self.board[cell1][cell2].name, self.board[cell1][cell2].color, coord1, self.get_pos(coord2)):
